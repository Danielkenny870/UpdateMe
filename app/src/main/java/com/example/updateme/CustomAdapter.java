...
public class CustomAdapter extends RecyclerView.Adapter<CustomViewHolder>{
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder holder, int position) {
        ...
        //since the name is inside the Source and the Source inside the Article from te API
        ...
        //in onBindView, Creating listener Object for the CardView that acts as a Container of the Item of the RecyclerView
